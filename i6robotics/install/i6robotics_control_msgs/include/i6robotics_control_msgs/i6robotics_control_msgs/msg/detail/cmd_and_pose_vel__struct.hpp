...
#ifndef I6ROBOTICS_CONTROL_MSGS__MSG__DETAIL__CMD_AND_POSE_VEL__STRUCT_HPP_
#define I6ROBOTICS_CONTROL_MSGS__MSG__DETAIL__CMD_AND_POSE_VEL__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__i6robotics_control_msgs__msg__CmdAndPoseVel __attribute__((deprecated))
#else
# define DEPRECATED__i6robotics_control_msgs__msg__CmdAndPoseVel __declspec(deprecated)
#endif
...
struct CmdAndPoseVel_
{
  ...
  // pointer types
  using RawPtr =
    i6robotics_control_msgs::msg::CmdAndPoseVel_<ContainerAllocator> *;
  using ConstRawPtr =
    const i6robotics_control_msgs::msg::CmdAndPoseVel_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<i6robotics_control_msgs::msg::CmdAndPoseVel_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<i6robotics_control_msgs::msg::CmdAndPoseVel_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      i6robotics_control_msgs::msg::CmdAndPoseVel_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<i6robotics_control_msgs::msg::CmdAndPoseVel_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<i6robotics_control_msgs::msg::CmdAndPoseVel_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<i6robotics_control_msgs::msg::CmdAndPoseVel_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<i6robotics_control_msgs::msg::CmdAndPoseVel_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__i6robotics_control_msgs__msg__CmdAndPoseVel
    std::shared_ptr<i6robotics_control_msgs::msg::CmdAndPoseVel_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__i6robotics_control_msgs__msg__CmdAndPoseVel
    std::shared_ptr<i6robotics_control_msgs::msg::CmdAndPoseVel_<ContainerAllocator> const>
...
using CmdAndPoseVel =
  i6robotics_control_msgs::msg::CmdAndPoseVel_<std::allocator<void>>;
...
#endif  // I6ROBOTICS_CONTROL_MSGS__MSG__DETAIL__CMD_AND_POSE_VEL__STRUCT_HPP_
