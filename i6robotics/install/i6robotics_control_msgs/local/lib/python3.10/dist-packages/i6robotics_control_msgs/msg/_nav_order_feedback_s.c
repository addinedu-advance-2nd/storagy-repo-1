...
bool i6robotics_control_msgs__msg__nav_order_feedback__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("i6robotics_control_msgs.msg._nav_order_feedback.NavOrderFeedback", full_classname_dest, 64) == 0);
  }
  i6robotics_control_msgs__msg__NavOrderFeedback * ros_message = _ros_message;
  {  // current_pose
...
{
  /* NOTE(esteve): Call constructor of NavOrderFeedback */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("i6robotics_control_msgs.msg._nav_order_feedback");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "NavOrderFeedback");
