...
bool i6robotics_control_msgs__msg__cmd_and_pose_vel__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("i6robotics_control_msgs.msg._cmd_and_pose_vel.CmdAndPoseVel", full_classname_dest, 59) == 0);
  }
  i6robotics_control_msgs__msg__CmdAndPoseVel * ros_message = _ros_message;
  {  // cmd_vel_linear
...
PyObject * i6robotics_control_msgs__msg__cmd_and_pose_vel__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("i6robotics_control_msgs.msg._cmd_and_pose_vel");
