...
#include "i6robotics_control_msgs/srv/detail/order__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = i6robotics_control_msgs::srv::Order_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const i6robotics_control_msgs::srv::Order_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<i6robotics_control_msgs::srv::Order_Request *>(
    untyped_ros_message);
...
{
  return &i6robotics_control_msgs::srv::typesupport_fastrtps_cpp::_Order_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = i6robotics_control_msgs::srv::Order_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const i6robotics_control_msgs::srv::Order_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<i6robotics_control_msgs::srv::Order_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &i6robotics_control_msgs::srv::typesupport_fastrtps_cpp::_Order_Response__handle;
}
...
{
  return &i6robotics_control_msgs::srv::typesupport_fastrtps_cpp::_Order__handle;
}
