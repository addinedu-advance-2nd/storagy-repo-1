...
#include "i6robotics_control_msgs/msg/detail/cmd_and_pose_vel__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const i6robotics_control_msgs::msg::CmdAndPoseVel & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  i6robotics_control_msgs::msg::CmdAndPoseVel & ros_message)
{
  // Member: cmd_vel_linear
  cdr >> ros_message.cmd_vel_linear;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = i6robotics_control_msgs::msg::CmdAndPoseVel;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const i6robotics_control_msgs::msg::CmdAndPoseVel *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<i6robotics_control_msgs::msg::CmdAndPoseVel *>(
    untyped_ros_message);
...
{
  return &i6robotics_control_msgs::msg::typesupport_fastrtps_cpp::_CmdAndPoseVel__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, i6robotics_control_msgs, msg, CmdAndPoseVel)() {
  return &i6robotics_control_msgs::msg::typesupport_fastrtps_cpp::_CmdAndPoseVel__handle;
}
