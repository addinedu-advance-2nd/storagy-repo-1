...
#include "i6robotics_control_msgs/srv/detail/order__rosidl_typesupport_fastrtps_c.h"
...
using _Order_Request__ros_msg_type = i6robotics_control_msgs__srv__Order_Request;
...
size_t get_serialized_size_i6robotics_control_msgs__srv__Order_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Order_Request__ros_msg_type * ros_message = static_cast<const _Order_Request__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Order_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_i6robotics_control_msgs__srv__Order_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_i6robotics_control_msgs
size_t max_serialized_size_i6robotics_control_msgs__srv__Order_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = i6robotics_control_msgs__srv__Order_Request;
    is_plain =
      (
...
static size_t _Order_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_i6robotics_control_msgs__srv__Order_Request(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, i6robotics_control_msgs, srv, Order_Request)() {
...
using _Order_Response__ros_msg_type = i6robotics_control_msgs__srv__Order_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_i6robotics_control_msgs
size_t get_serialized_size_i6robotics_control_msgs__srv__Order_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Order_Response__ros_msg_type * ros_message = static_cast<const _Order_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_i6robotics_control_msgs__srv__Order_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_i6robotics_control_msgs
size_t max_serialized_size_i6robotics_control_msgs__srv__Order_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = i6robotics_control_msgs__srv__Order_Response;
    is_plain =
      (
...
static size_t _Order_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_i6robotics_control_msgs__srv__Order_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, i6robotics_control_msgs, srv, Order_Response)() {
...
// already included above
// #include "i6robotics_control_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "i6robotics_control_msgs/srv/order.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, i6robotics_control_msgs, srv, Order)() {
