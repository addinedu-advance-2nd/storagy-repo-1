...
#include "i6robotics_control_msgs/msg/detail/cmd_and_pose_vel__rosidl_typesupport_fastrtps_c.h"
...
using _CmdAndPoseVel__ros_msg_type = i6robotics_control_msgs__msg__CmdAndPoseVel;
...
size_t get_serialized_size_i6robotics_control_msgs__msg__CmdAndPoseVel(
  const void * untyped_ros_message,
...
static uint32_t _CmdAndPoseVel__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_i6robotics_control_msgs__msg__CmdAndPoseVel(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_i6robotics_control_msgs
size_t max_serialized_size_i6robotics_control_msgs__msg__CmdAndPoseVel(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = i6robotics_control_msgs__msg__CmdAndPoseVel;
    is_plain =
      (
...
static size_t _CmdAndPoseVel__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_i6robotics_control_msgs__msg__CmdAndPoseVel(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, i6robotics_control_msgs, msg, CmdAndPoseVel)() {
