...
static const _NavOrderFeedback_type_support_symbol_names_t _NavOrderFeedback_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, i6robotics_control_msgs, msg, NavOrderFeedback)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, i6robotics_control_msgs, msg, NavOrderFeedback)),
  }
};
...
{
  return &::i6robotics_control_msgs::msg::rosidl_typesupport_cpp::NavOrderFeedback_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, i6robotics_control_msgs, msg, NavOrderFeedback)() {
  return get_message_type_support_handle<i6robotics_control_msgs::msg::NavOrderFeedback>();
}
