...
static const _Order_Request_type_support_symbol_names_t _Order_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, i6robotics_control_msgs, srv, Order_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, i6robotics_control_msgs, srv, Order_Request)),
  }
};
...
{
  return &::i6robotics_control_msgs::srv::rosidl_typesupport_cpp::Order_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, i6robotics_control_msgs, srv, Order_Request)() {
  return get_message_type_support_handle<i6robotics_control_msgs::srv::Order_Request>();
}
...
static const _Order_Response_type_support_symbol_names_t _Order_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, i6robotics_control_msgs, srv, Order_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, i6robotics_control_msgs, srv, Order_Response)),
  }
};
...
{
  return &::i6robotics_control_msgs::srv::rosidl_typesupport_cpp::Order_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, i6robotics_control_msgs, srv, Order_Response)() {
  return get_message_type_support_handle<i6robotics_control_msgs::srv::Order_Response>();
}
...
static const _Order_type_support_symbol_names_t _Order_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, i6robotics_control_msgs, srv, Order)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, i6robotics_control_msgs, srv, Order)),
  }
};
...
{
  return &::i6robotics_control_msgs::srv::rosidl_typesupport_cpp::Order_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, i6robotics_control_msgs, srv, Order)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<i6robotics_control_msgs::srv::Order>();
}
