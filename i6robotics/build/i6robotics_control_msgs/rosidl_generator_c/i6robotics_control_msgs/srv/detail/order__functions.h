...
#ifndef I6ROBOTICS_CONTROL_MSGS__SRV__DETAIL__ORDER__FUNCTIONS_H_
#define I6ROBOTICS_CONTROL_MSGS__SRV__DETAIL__ORDER__FUNCTIONS_H_
 ...
 * calls
 * i6robotics_control_msgs__srv__Order_Request__init().
...
/**
 * It calls
 * i6robotics_control_msgs__srv__Order_Request__fini()
 ...
 * i6robotics_control_msgs__srv__Order_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * i6robotics_control_msgs__srv__Order_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * i6robotics_control_msgs__srv__Order_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_i6robotics_control_msgs
...
/**
 * It calls
 * i6robotics_control_msgs__srv__Order_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_i6robotics_control_msgs
...
/**
 * It allocates the memory for the array and calls
 * i6robotics_control_msgs__srv__Order_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_i6robotics_control_msgs
...
/**
 * It calls
 * i6robotics_control_msgs__srv__Order_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // I6ROBOTICS_CONTROL_MSGS__SRV__DETAIL__ORDER__FUNCTIONS_H_
