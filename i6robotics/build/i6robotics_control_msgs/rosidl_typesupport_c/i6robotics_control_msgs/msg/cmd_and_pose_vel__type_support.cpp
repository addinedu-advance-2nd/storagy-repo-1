...
static const _CmdAndPoseVel_type_support_symbol_names_t _CmdAndPoseVel_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, i6robotics_control_msgs, msg, CmdAndPoseVel)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, i6robotics_control_msgs, msg, CmdAndPoseVel)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, i6robotics_control_msgs, msg, CmdAndPoseVel)() {
  return &::i6robotics_control_msgs::msg::rosidl_typesupport_c::CmdAndPoseVel_message_type_support_handle;
}
