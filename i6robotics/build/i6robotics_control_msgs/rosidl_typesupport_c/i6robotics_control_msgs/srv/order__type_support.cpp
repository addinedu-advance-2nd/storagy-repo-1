...
static const _Order_Request_type_support_symbol_names_t _Order_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, i6robotics_control_msgs, srv, Order_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, i6robotics_control_msgs, srv, Order_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, i6robotics_control_msgs, srv, Order_Request)() {
  return &::i6robotics_control_msgs::srv::rosidl_typesupport_c::Order_Request_message_type_support_handle;
}
...
static const _Order_Response_type_support_symbol_names_t _Order_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, i6robotics_control_msgs, srv, Order_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, i6robotics_control_msgs, srv, Order_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, i6robotics_control_msgs, srv, Order_Response)() {
  return &::i6robotics_control_msgs::srv::rosidl_typesupport_c::Order_Response_message_type_support_handle;
}
...
static const _Order_type_support_symbol_names_t _Order_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, i6robotics_control_msgs, srv, Order)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, i6robotics_control_msgs, srv, Order)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, i6robotics_control_msgs, srv, Order)() {
  return &::i6robotics_control_msgs::srv::rosidl_typesupport_c::Order_service_type_support_handle;
}
